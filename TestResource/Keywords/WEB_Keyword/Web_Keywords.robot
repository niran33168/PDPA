...
AddUser
    ...
    Click Element                    xpath=//div[@title="ตำแหน่ง"]/../div
    Click Element                    xpath=//div[@class="dx-item-content dx-list-item-content"][contains(text(),'ADMIN : Administrator)]
    InputValue                       xpath=//input[@name="WorkStart"]/../div//input    ${data_test['user.workstart']}
    Click Element                    xpath=//div[@id="gridContainer"]//div[@class="dx-item-content dx-toolbar-item-content"]
    Click Element                    xpath=//div[@id="gridContainer"]//input[@class="dx-texteditor-input"]
    ...
    Click Element                    xpath=//div[@id="icon-save"]
