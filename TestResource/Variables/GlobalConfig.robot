...
${MENU_PURPOSE_CATEGORY}    xpath=//span[contains(text(),'Purpose category')]/../../div[@class="dx-item-content dx-treeview-item-content"]
${MENU_PURPOSE}             xpath=//span[contains(text(),'Purpose')]/../../div[@class="dx-item-content dx-treeview-item-content"]
...
${TXT_PURPOSE_CATEGORY_DESCRIPTION}       xpath=//input[@name="Description"]
...
${DDL_PURPOSE_TYPE}    xpath=/input[@name="purposeType"]/../div
${DDL_PURPOSE_CATEGORY}    xpath=/input[@name="PurposeCategoryID"]/../div
${TXT_PURPOSE_CODE}              xpath=//input[@name="Code"]
${TXT_PURPOSE_DESCRIPTION}       xpath=//input[@name="Description"]
