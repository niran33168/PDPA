...
${MENU_GENERAL_CONSENT}     xpath=//span[contains(text(),'General consent')]/../../../div
${MENU_COLLECTION_POINT}    xpath=//span[contains(text(),'Collection point')]/../../../div
...
${BTN_EDIT}           xpath=//div[2]/table/tbody/tr[1]/td[1]/a[@class="dx-link dx-icon-edit dx-link-icon"]
${BTN_DELETE}         xpath=//div[2]/table/tbody/tr[1]/td[1]/a[@class="dx-link dx-link-delete dx-icon-trash dx-link-icon"]
...
### Collection point ###
${HEADER_MENU_COLLECTION_POINT}           xpath=//span[contains(text(),'Collection point')]
${HEADER_MENU_ADD_COLLECTION_POINT}       xpath=//span[contains(text(),'Add collection point')]
${HEADER_MENU_UPDATE_COLLECTION_POINT}    xpath=//span[contains(text(),'Update collection                      point')]
${HEADER_MENU_PAGE_CONSENT}               xpath=//span[contains(text(),'Consent page setting')]
...
&{API_COLLECTIONPOINT_ERROR}          uat=/cms/general-consent/ERROR          sit=/cms/general-consent/ERROR
