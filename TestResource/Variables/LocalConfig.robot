...
#### EXCEL ####
${EXCEL_PDPA}                    ./TestResource/DataTest/Excel_Script/PDPA_Script.xlsx
${SHEET_CollectionPointList}     CollectionPointList
${SHEET_CollectionPointInfo}     CollectionPointInfo
...
${JSON_CollectionPoint_Info}     ./API_CollectionPoint/CollectionPointInfo
